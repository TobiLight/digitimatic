...
const WorkWithUs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="work-with-us" class="work-with-us bg-black border-t-2 border-gray-500 p-8 relative"><div class="bg-blak z-[0] relative opacity-80"><h1 class="text-white font-bold text-center text-2xl" data-svelte-h="svelte-1igfcv3">WORK WITH US</h1> <div class="w-[80px] mt-2 rounded-full h-1 mx-auto bg-white"></div> <form action="#" method="post" class="${escape(
...
const Testimonials = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="testimonials" class="success-stories bg-black p-8 py-20 text-white relative"><div${add_attribute(
    ...
    0
  )}><div class="flex items-center lg:items-end gap-3 rounded-full border border-white p-4">${validate_component(Graph, "Graph").$$render($$result, { class: "text-white w-32 h-32" }, {}, {})}</div> <div class="grid gap-2" data-svelte-h="svelte-1s9z4bq"><h1 class="text-4xl md:text-6xl lg:text-7xl font-extrabold">Success Stories</h1> <p class="text-xl sm:text-2xl">Recognizing the strength of your business is important, but when
