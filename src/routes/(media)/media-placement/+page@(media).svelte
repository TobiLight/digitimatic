	...
	<div class="pt-8">
		...
		<div class="offer grid gap-y-8 mx-auto">
			...
			<ul class="list-disc px-8 md:px-0 w-auto grid gap-y-4">
				...
				<li>
					If you're reading this, it's because you've seen my social media, someone referred you to
					me or maybe you saw an AD.
				</li>
				<li>
					Truth is, I'm one of the fastest growing PR figures on the internet. And I don't say that
					to brag, I'll just show you the results I get.
				</li>
			</ul>
		</div>
		...
		<div class="sect-3 grid sm:grid-cols-2 items-center gap-x-10 gap-y-20 mt-20">
			<img
				width="100%"
				height="100%"
				src="https://res.cloudinary.com/ddt59lbmx/image/upload/f_auto,q_auto/v1/digitimatic/photos/yoxppezexv0urmqwxnqm"
				alt="Digitimatic 1"
			...
			<img
				width="100%"
				height="100%"
				src="https://res.cloudinary.com/ddt59lbmx/image/upload/f_auto,q_auto/v1/digitimatic/photos/m5gd526ku7avfv2rkhvx"
				alt="Digitimatic 2"
			...
			<img
				width="100%"
				height="100%"
				src="https://res.cloudinary.com/ddt59lbmx/image/upload/f_auto,q_auto/v1/digitimatic/photos/dggn60si5qvfvdrjkoyx"
				alt="Digitimatic 3"
				class="w-auto h-auto mx-auto"
			/>
			<img
				width="100%"
				height="100%"
				src="https://res.cloudinary.com/ddt59lbmx/image/upload/f_auto,q_auto/v1/digitimatic/photos/dtxkfpox0cbfepzz0q0k"
				alt="Digitimatic 4"
				class="w-auto h-auto mx-auto"
			/>
			<img
				width="100%"
				height="100%"
				src="https://res.cloudinary.com/ddt59lbmx/image/upload/f_auto,q_auto/v1/digitimatic/photos/zu5zwhmceodakdttvuxq"
				alt="Digitimatic 5"
				class="w-auto h-auto mx-auto"
			/>
			<img
				width="100%"
				height="100%"
				src="https://res.cloudinary.com/ddt59lbmx/image/upload/f_auto,q_auto/v1/digitimatic/photos/bze84zutbbrkfkexvq8o"
				alt="Digitimatic 6"
				class="w-auto h-auto mx-auto"
			/>
			<img
				width="100%"
				height="100%"
				src="https://res.cloudinary.com/ddt59lbmx/image/upload/f_auto,q_auto/v1/digitimatic/photos/dxsukmk3ayg2h49k1uh9"
				alt="Digitimatic 7"
				class="w-auto h-auto mx-auto"
			/>
		</div>
		...
		<div class="sect-4 py-14 grid gap-y-10">
			...
			<div class="grid gap-y-6">
				...
				<p>Let me explain...</p>
				<p>
					My goal is to become the #1 PR agency in the entire globe for business owners that relay
		...
		<div class="sect-5 grid gap-y-10">
			...
			<ul class="list-disc px-8 md:px-0 w-auto grid gap-y-4">
				...
				<li>
					...
					the attention of other high-profile companies or individuals.
				</li>
			</ul>
		</div>
