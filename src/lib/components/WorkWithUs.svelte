...
<section
	...
	class={`${
		...
		} work-with-us relative bottom-[-120px] xs:bottom-[-140px] bg-[lightgreen] border-4 border-green-500 p-16 w-11/12 xs:w-3/4 sm:w-4/5 md:w-2/3 mx-auto rounded-xl grid items-center`}
	use:inview={options}
	on:inview_change={(e) => {
